...
var bengaliRegex = /(র্){0,1}([অ-হড়-য়](?:্[অ-মশ-হড়-য়])*)((‍){0,1}(্[য-ল])){0,1}([া-ৌ]){0,1}|[্ঁঃংৎ০-৯]/g;


function replacer(match, reff, mUnit, posPhala, noPrint, posPhalaTrail, kaar, offset, string){
  console.log(match, reff, mUnit, posPhala, noPrint, posPhalaTrail, kaar, offset, string);
  ...
  if (posPhala){
    ...
    // } else {
    //   let unt = mUnit + posPhalaTrail;
    //   console.log(unt);
    //   mainConv = unt.replace(bengaliRegex, replacer);
    // }
  } else {
